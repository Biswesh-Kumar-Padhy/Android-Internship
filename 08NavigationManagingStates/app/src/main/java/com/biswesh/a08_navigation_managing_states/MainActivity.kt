package com.biswesh.a08_navigation_managing_states
...
import com.biswesh.a08_navigation_managing_states.ui.theme._08NavigationManagingStatesTheme

class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            _08NavigationManagingStatesTheme {
                Column {
                    AppNavigation()
                    CounterScreen()
                }
